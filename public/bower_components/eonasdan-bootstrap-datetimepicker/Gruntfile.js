    ...
    grunt.initConfig({
        ...
        less: {
            production: {
                ...
                files: {
                    'build/css/bootstrap-datetimepicker.min.css': 'src/less/eonasdan-bootstrap-datetimepicker-build.less'
                }
            },
            development: {
                options: {
                ...
                files: {
                    'build/css/bootstrap-datetimepicker.css': 'src/less/eonasdan-bootstrap-datetimepicker-build.less'
                }
            }
        },
        env: {
