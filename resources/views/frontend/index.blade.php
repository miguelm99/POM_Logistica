                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-2 col-lg-1 col-md-1">
                                <div class="logo">
                                <a href="index.blade.php"><img src="inds/assets/img/logo/logo.png" alt=""></a>
                                </div>
                            </div>
                                ...
                                <div class="main-menu f-right d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a href="#">Pages</a>
                                                <ul class="submenu">
                                                    <li><a href="inds/contact.html">Contact</a></li>
                                                    <li><a href="inds/elements.html">Element</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </nav>
                                ...
                                <div id="mc_embed_signup">
                                    ...
                                    method="get" class="subscribe_form relative mail_part">
                                        ...
                                        <div class="form-icon">
                                            ...
                                            class="email_icon newsletter-submit button-contactForm"><img src="inds/assets/img/icon/form_icon.png" alt=""></button>
                                        </div>
