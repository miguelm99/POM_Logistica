...
<table class="table table-bordered">
    ...
    @foreach ($indexs as $index)
        <tr>
            ...
            @if(!is_null($index->patrocinios_img))
            <td><img src="{{ URL::to('/') }}/images/{{ $index->patrocinios_img }}" class="img-thumbnail" width="75" /></td>
            @else
            <td><img src="{{ URL::to('/') }}/images/noimage.jpg" class="img-thumbnail" width="75" /></td>
            @endif
            <td>
